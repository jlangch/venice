...
- [#11](https://github.com/jlangch/venice/issues/11): Support *Hybrid Encryption* for
  remote REPL communication to achieve TLS/SSH grade security.
    * **Level 0**: Client authentication through principal/password, no encryption
  ...
  *Note:* Hybrid encryption can also be used by tunneling *Level 0* remote REPL 
  communication through an accordingly configured SSH tunnel.
