...
public class ParsifalModuleExprParserTest {
    ...
    public void test() {
        ...
        final Map<Object,Object> result = (Map<Object,Object>)venice.eval(
                                                "parsifal-expr-parser-test.venice",
                                                loadScript("parsifal-expr-parser-test.venice"));

        assertEquals( 17, (long)result.get("test"));
        assertEquals(  0, (long)result.get("fail"));
        assertEquals(  0, (long)result.get("error"));

        assertEquals( 17, (long)result.get("pass"));
        assertEquals(122, (long)result.get("assert"));
    }
