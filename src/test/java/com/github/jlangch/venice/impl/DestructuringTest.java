...
public class DestructuringTest {
    ...
    public void test_sequential_string() {
        ...
        assertEquals("x", bindings.get(0).getName().getName());
        assertEquals('a', ((VncChar)bindings.get(0).getVal()).getValue());

        assertEquals("y", bindings.get(1).getName().getName());
        assertEquals('b', ((VncChar)bindings.get(1).getVal()).getValue());

        assertEquals("z", bindings.get(2).getName().getName());
        assertEquals('c', ((VncChar)bindings.get(2).getVal()).getValue());
    }
    ...
    public void test_sequential_string_multiple_elsision() {
        ...
        assertEquals("y", bindings.get(1).getName().getName());
        assertEquals('c', ((VncChar)bindings.get(1).getVal()).getValue());

        assertEquals("z", bindings.get(2).getName().getName());
        assertEquals('e', ((VncChar)bindings.get(2).getVal()).getValue());
    }
    ...
    public void test_sequential_string_fill_up() {
        ...
        assertEquals('c', ((VncChar)((VncList)bindings.get(2).getVal()).nth(0)).getValue());
        assertEquals('d', ((VncChar)((VncList)bindings.get(2).getVal()).nth(1)).getValue());
        assertEquals('e', ((VncChar)((VncList)bindings.get(2).getVal()).nth(2)).getValue());
        assertEquals('f', ((VncChar)((VncList)bindings.get(2).getVal()).nth(3)).getValue());
    }
