...
public class LoadPaths_slurp_Test {
    ...
    public void test_relative_limited() {
        TempFS.with((tempFS, root) -> {
            ...
            // from dir1
            assertEquals("res3", venice.eval("(io/slurp \"res3.txt\")"));

            // from dir1
            assertEquals("res4", venice.eval("(io/slurp \"11/res4.txt\")"));

            // from zip1.zip
            assertEquals("res11", venice.eval("(io/slurp \"res11.txt\")"));

            // from zip1.zip
            assertEquals("res12", venice.eval("(io/slurp \"dir-z1/res12.txt\")"));

            // from dir1/zip2.zip
            assertEquals("res21", venice.eval("(io/slurp \"res21.txt\")"));
