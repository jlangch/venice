...
public class JsonFunctionsTest {
    ...
    public void test_json_read_str_decimal() {
        ...
        assertEquals(
                "{:a 100 :b 100.33M}",
                venice.eval("(pr-str (json/read-str \"\"\"{\"a\": 100, \"b\": 100.33}\"\"\" :key-fn keyword :decimal true))"));

        // large decimal
        assertEquals(
                "{:a 100 :b 99999999999999999999999999999999999999999999999999.33M}",
                venice.eval("(pr-str (json/read-str \"\"\"{\"a\": 100, \"b\": 99999999999999999999999999999999999999999999999999.33}\"\"\" :key-fn keyword :decimal true))"));
        ...
        assertEquals(
                ...
                venice.eval("(pr-str (json/read-str \"\"\"{\"a\": 100, \"b\": 999999999999999999999999999999999999999999999999999999999999999999999.333333333333333333333333333333333333333333333333333333333333333333333333333333333333333}\"\"\" :key-fn keyword :decimal true))"));
    }
