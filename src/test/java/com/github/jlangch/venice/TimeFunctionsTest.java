...
public class TimeFunctionsTest {
	...
	public void test_zoned_date_time() {
		...
		assertTrue(venice.eval("(time/zoned-date-time \"2018-08-01T10:15:30.000+01:00\")") instanceof ZonedDateTime);		
		...
		assertTrue(venice.eval("(time/zoned-date-time :UTC \"2018-08-01T10:15:30.000+01:00\")") instanceof ZonedDateTime);		
