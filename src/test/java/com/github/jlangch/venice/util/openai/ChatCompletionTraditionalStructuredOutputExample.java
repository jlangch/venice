...
public class ChatCompletionTraditionalStructuredOutputExample {

    private ChatCompletionTraditionalStructuredOutputExample() {}
        ...
        final ChatCompletionTraditionalRequest request =
                ChatCompletionTraditionalRequest
                    ...
                    .jsonResponseFormat(
                            ...
                            "A list of employees",
                            "object",
                            toMap("employees", toMap("items", toMap("type", "string"))))
