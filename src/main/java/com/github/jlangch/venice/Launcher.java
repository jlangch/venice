 ...
 *
 * <p>Running scripts:
 * <pre>java -jar venice-1.12.60.jar -script "(+ 1 1)"</pre>
 *
 * <p>Running a REPL:
 * <pre>
 *    java \
 ...
 *
 *  -setup             setup a REPL
 *                     E.g.:  java -jar venice-1.12.60.jar -setup -colors \n" +
 *                            java -jar venice-1.12.60.jar -setup -colors-light \n" +
 *                            java -jar venice-1.12.60.jar -setup -colors-dark \n" +
 *                            java -jar venice-1.12.60.jar -setup -colors -dir /Users/foo/repl \n" +
 *
 *  -help              prints a help
 *  </pre>
 *
...
public class Launcher {
    ...
    private static void printHelp() {
        System.out.println(
             ...
             "\n" +
             "Running scripts: \n" +
             "    java -jar venice-1.12.60.jar -script \"(+ 1 1)\" \n" +
             "\n" +
             "Running a REPL:  \n" +
             "    java \\ \n" +
             "       -server \\ \n" +
