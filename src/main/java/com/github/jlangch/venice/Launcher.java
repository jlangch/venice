 ...
 *
 * <p>Running scripts:
 * <pre>java -jar venice-1.13.9.jar -script "(+ 1 1)"</pre>
 *
 * <p>Running a REPL:
 * <pre>
 *    java \
...
public class Launcher {
    ...
    private static void printHelp() {
        System.out.println(
             ...
             "\n" +
             "Running scripts: \n" +
             "    java -jar venice-1.13.9.jar -script \"(+ 1 1)\" \n" +
             "\n" +
             "Running a REPL:  \n" +
             "    java \\ \n" +
             "       -server \\\n" +
             ...
             "\n" +
             "  -setup            setup a REPL \n" +
             "                    e.g.:  java -jar venice-1.13.9.jar -setup -colors -dir ./repl \n" +
             "                           java -jar venice-1.13.9.jar -setup -minimal -colors -dir ./repl \n" +
             "                           java -jar venice-1.13.9.jar -setup -colors-light -dir ./repl \n" +
             "                           java -jar venice-1.13.9.jar -setup -colors-dark -dir ./repl \n" +
             "\n" +
