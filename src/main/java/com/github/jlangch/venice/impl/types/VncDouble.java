...
public class VncDouble extends VncVal {
	...
	public VncDouble add(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncDouble(value + ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
			return new VncDouble(value + ((VncDouble)other).getValue());
		}
		else if (other instanceof VncBigDecimal) {
			return new VncDouble(value + ((VncBigDecimal)other).getValue().doubleValue());
		}
		else {
	...
	public VncDouble subtract(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncDouble(value - ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
	...
	public VncDouble multiply(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncDouble(value * ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
	...
	public VncDouble divide(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncDouble(value / ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
