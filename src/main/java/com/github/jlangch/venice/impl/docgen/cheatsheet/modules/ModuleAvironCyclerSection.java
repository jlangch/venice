...
public class ModuleAvironCyclerSection implements ISectionBuilder {

    public ModuleAvironCyclerSection(final DocItemBuilder diBuilder) {
    ...
    public DocSection section() {
        final DocSection section = new DocSection(
                                            "Aviron Dir Cycler",
                                            "ClamAV client directory cycler",
                                            "modules.aviron-cycler");

        final DocSection all = new DocSection("(load-module :aviron-cycler)", id());
        section.addSection(all);


        final DocSection cycler = new DocSection("Dir Cycler", id());
