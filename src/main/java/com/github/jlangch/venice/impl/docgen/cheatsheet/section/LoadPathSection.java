...
public class LoadPathSection implements ISectionBuilder {

    public LoadPathSection(final DocItemBuilder diBuilder) {
        this.diBuilder = diBuilder;
    }

    @Override
    public DocSection section() {
        final DocSection section = new DocSection("Loadpaths", "loadpaths");
