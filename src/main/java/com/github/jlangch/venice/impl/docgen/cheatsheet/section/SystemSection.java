...
public class SystemSection implements ISectionBuilder {
    ...
    public DocSection section() {
        ...
        venice.addItem(diBuilder.getDocItem("latest", false));
        venice.addItem(diBuilder.getDocItem("parse-version"));
        venice.addItem(diBuilder.getDocItem("newer-version?"));
        ...
        all.addSection(java);
        java.addItem(diBuilder.getDocItem("java-home"));
        ...
        java.addItem(diBuilder.getDocItem("java-vm-args"));
