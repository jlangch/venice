...
import com.github.jlangch.venice.impl.docgen.cheatsheet.modules.ModuleOpenAiJavaSection;
...
import com.github.jlangch.venice.impl.docgen.cheatsheet.modules.ModuleSwissCitiesSection;
...
import com.github.jlangch.venice.impl.docgen.cheatsheet.section.IpcSection;
...
public class DocGenerator {
    ...
    public DocGenerator(final boolean runExamples) {
        ...
        final Env env = ReplFunctions.registerAll(docEnv, null, null, null, false, ReplDirs.notavail());
    ...
    private List<DocSection> getTOC() {
        ...
        extmod.addSection(new DocSection("Swiss Cities", "modules.swisscities"));
    ...
    private List<DocSection> getModulesRightSections() {
        return Arrays.asList(
                ...
                new ModuleSwissCitiesSection(diBuilder).section(),
                ...
                new ModuleOpenAiJavaSection(diBuilder).section(),
