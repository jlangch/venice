...
public class VncBigDecimal extends VncVal {
	...
	public VncBigDecimal add(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncBigDecimal(value.add(toDecimal((VncLong)other).getValue()));
		}
		else if (other instanceof VncDouble) {
			return new VncBigDecimal(value.add(toDecimal((VncDouble)other).getValue()));
		}
		else if (other instanceof VncBigDecimal) {
			return new VncBigDecimal(value.add(((VncBigDecimal)other).getValue()));
		}
		else {
	...
	public VncBigDecimal subtract(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncBigDecimal(value.subtract(toDecimal((VncLong)other).getValue()));
		}
		else if (other instanceof VncDouble) {
			return new VncBigDecimal(value.subtract(toDecimal((VncDouble)other).getValue()));
		}
		else if (other instanceof VncBigDecimal) {
			return new VncBigDecimal(value.subtract(((VncBigDecimal)other).getValue()));
		}
		else {
			throw new VncException(String.format(
									"Function '-' with operand 1 of type %s does not allow %s as operand 2", 
	...
	public VncBigDecimal multiply(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncBigDecimal(value.multiply(toDecimal((VncLong)other).getValue()));
		}
		else if (other instanceof VncDouble) {
			return new VncBigDecimal(value.multiply(toDecimal((VncDouble)other).getValue()));
		}
		else if (other instanceof VncBigDecimal) {
			return new VncBigDecimal(value.multiply(((VncBigDecimal)other).getValue()));
		}
		else {
			throw new VncException(String.format(
									"Function '*' with operand 1 of type %s does not allow %s as operand 2", 
	...
	public VncBigDecimal divide(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncBigDecimal(value.divide(toDecimal((VncLong)other).getValue(), 16, RoundingMode.HALF_UP));
		}
		else if (other instanceof VncDouble) {
			return new VncBigDecimal(value.divide(toDecimal((VncDouble)other).getValue(), 16, RoundingMode.HALF_UP));
		}
		else if (other instanceof VncBigDecimal) {
			return new VncBigDecimal(value.divide(((VncBigDecimal)other).getValue(), 16, RoundingMode.HALF_UP));
		}
		else {
			throw new VncException(String.format(
									"Function '/' with operand 1 of type %s does not allow %s as operand 2", 
