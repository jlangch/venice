...
public class VncLong extends VncVal {
	...
	public VncLong add(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncLong(value + ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
			return new VncLong(value + ((VncDouble)other).getValue().longValue());
		}
		else if (other instanceof VncBigDecimal) {
			return new VncLong(value + ((VncBigDecimal)other).getValue().longValue());
		}
		else {
	...
	public VncLong subtract(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncLong(value - ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
	...
	public VncLong multiply(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncLong(value * ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
	...
	public VncLong divide(final VncVal other) {
		if (other instanceof VncLong) {
			return new VncLong(value / ((VncLong)other).getValue());
		}
		else if (other instanceof VncDouble) {
