...
public class ModuleQrBillSection implements ISectionBuilder {

    public ModuleQrBillSection(final DocItemBuilder diBuilder) {
    ...
    public DocSection section() {
        ...
        final DocSection main = new DocSection("QR Bill", id());
        all.addSection(main);
