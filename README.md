...
Venice, a sandboxed Lisp dialect with Java interoperability serving as 
...
[Cheat Sheet HTML](https://cdn.rawgit.com/jlangch/venice/3cf9c09/cheatsheet.html)

[Cheat Sheet PDF](https://cdn.rawgit.com/jlangch/venice/3cf9c09/cheatsheet.pdf)
...
Start the REPL with `java -jar venice-1.1.1.jar`
...
```text
foo> java -jar venice-1.1.1.jar -script "(+ 1 1)"
=> 2
```

```text
foo> echo "(+ 1 1)" > script.venice
foo> java -jar venice-1.1.1.jar -file script.venice
=> 2
```
...
;;
;; > java -jar venice-1.1.1.jar -file zip-tomcat-logs.venice ./logs
;; ----------------------------------------------------------------------------------
(do
...
```groovy
dependencies {
    compile 'com.github.jlangch:venice:1.1.1'
}
```
