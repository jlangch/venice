...
[Cheat Sheet](https://cdn.rawgit.com/jlangch/venice/fb56310/cheatsheet.pdf)
 
...
```shell
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.83/venice-1.12.84.jar" --output ./venice-1.12.84.jar
```
