...
``` text
foo> java -jar venice-1.13.12.jar -script "(+ 1 1)"
=> 2
```
...
``` text
foo> java -jar venice-1.13.12.jar -file script.venice
=> 19.634954084936208
```
...
``` text
foo> java -jar venice-1.13.12.jar -file script.venice 3
=> 4
```
...
foo> java -jar libs/venice-1.13.12.jar -file script.venice -loadpath "/users/foo/venice/scripts"
```
