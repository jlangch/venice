...
```text
foo> java -jar venice-1.7.15.jar -script "(+ 1 1)"
=> 2
```
...
```text
foo> java -jar venice-1.7.15.jar -file script.venice
=> 19.634954084936208
```
...
```text
foo> java -jar venice-1.7.15.jar -file script.venice 3
=> 4
```
...
foo> java -jar bin/venice-1.7.15.jar -file script.venice -loadpath "/users/foo/venice/scripts"
```
