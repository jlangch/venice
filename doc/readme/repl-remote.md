...
``` shell
java -jar ./venice-1.13.7.jar -repl-port 33334 -repl-pwd 123 -file ./remote-repl-demo.venice
```
...
``` shell
java -jar ./venice-1.13.7.jar -repl-port 33334 -repl-pwd 123 -file ./remote-repl-trace-demo.venice
```
...
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.13.0/venice-1.13.7.jar

java -jar ./venice-1.13.7.jar -repl -colors
```
...
java -jar ./venice-1.13.7.jar -repl
```
