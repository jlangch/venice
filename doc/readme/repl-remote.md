...
``` shell
java -jar ./venice-1.12.85.jar -repl-port 33334 -repl-pwd 123 -file ./remote-repl-demo.venice
```
...
``` shell
java -jar ./venice-1.12.85.jar -repl-port 33334 -repl-pwd 123 -file ./remote-repl-trace-demo.venice
```
