...
Download Venice from Maven: [Venice](https://search.maven.org/artifact/com.github.jlangch/venice/1.10.3/jar)
...
```text
foo> java -jar venice-1.10.3.jar -colors
```
...
```text
foo> java -cp venice-1.10.3.jar;jansi-2.3.2.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.10.3.jar -setup -colors
```
