...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.0/jar)
...
``` text
java -jar venice-1.13.0.jar -setup -colors -dir ./repl
```
...
``` text
java -jar venice-1.13.0.jar -setup -minimal -colors -dir ./repl
```
