...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.8/jar)

or download it with `curl`:

```
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.13.8/venice-1.13.8.jar
```
...
``` text
java -jar venice-1.13.8.jar -setup -colors -dir ./repl
```
...
``` text
java -jar venice-1.13.8.jar -setup -minimal -colors -dir ./repl
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/4a9e144/cheatsheet.pdf) and use it as a quick reference
