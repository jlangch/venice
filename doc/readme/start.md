...
Download Venice from Maven: [Venice](https://search.maven.org/artifact/com.github.jlangch/venice/1.10.54/jar)
...
```text
foo> java -jar venice-1.10.54.jar -colors
```

The REPL prompts for input:

```text
Venice REPL: V1.10.54
...
```text
foo> java -cp venice-1.10.54.jar;jansi-2.4.0.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.10.54.jar -setup -colors
```
