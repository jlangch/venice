...
```text
foo> java -jar venice-1.9.29.jar -colors
```
...
```text
foo> java -cp venice-1.9.29.jar;jansi-2.3.2.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.9.29.jar -setup -colors
```
