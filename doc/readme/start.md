...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.35/jar)

or download it with `curl`:

```
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.35/venice-1.12.35.jar" --output ./venice-1.12.35.jar
```
...
```text
foo> java -jar venice-1.12.35.jar -setup -colors
```
