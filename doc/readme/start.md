...
Download Venice from Maven: [Venice](https://search.maven.org/artifact/com.github.jlangch/venice/1.8.9/jar)
...
```text
foo> java -jar venice-1.8.9.jar -colors
```
...
```text
foo> java -jar venice-1.8.9.jar -setup -colors
```
