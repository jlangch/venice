...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.84/jar)

or download it with `curl`:

```
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.84/venice-1.12.84.jar" --output ./venice-1.12.84.jar
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/6766c58/cheatsheet.pdf) and use it as a quick reference
