...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.67/jar)

or download it with `curl`:

```
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.67/venice-1.12.67.jar" --output ./venice-1.12.67.jar
```
...
```text
foo> java -jar venice-1.12.67.jar -setup -colors
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/5af82b5/cheatsheet.pdf) and use it as a quick reference
