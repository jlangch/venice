...
Download Venice from Maven: [Venice](https://search.maven.org/artifact/com.github.jlangch/venice/1.9.11/jar)
...
```text
foo> java -jar venice-1.9.11.jar -colors
```
...
```text
foo> java -cp venice-1.9.11.jar;jansi-1.18.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.9.11.jar -setup -colors
```
