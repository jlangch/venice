...
```text
foo> java -jar venice-1.9.19.jar -colors
```
...
```text
foo> java -cp venice-1.9.19.jar;jansi-2.1.0.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.9.19.jar -setup -colors
```
