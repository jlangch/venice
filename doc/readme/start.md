...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.70/jar)

or download it with `curl`:

```
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.70/venice-1.12.70.jar" --output ./venice-1.12.70.jar
```
...
```text
foo> java -jar venice-1.12.70.jar -setup -colors
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/dbd735b/cheatsheet.pdf) and use it as a quick reference
