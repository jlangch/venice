...
Download Venice from Maven: [Venice](https://search.maven.org/artifact/com.github.jlangch/venice/1.11.0/jar)
...
```text
foo> java -jar venice-1.11.0.jar -colors
```
...
```text
foo> java -cp venice-1.11.0.jar;jansi-2.4.0.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.11.0.jar -setup -colors
```
