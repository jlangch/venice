...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.4/jar)
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/1b33f62/cheatsheet.pdf) and use it as a quick reference
