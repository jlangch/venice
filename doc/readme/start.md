...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.63/jar)

or download it with `curl`:

```
curl "https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.63/venice-1.12.63.jar" --output ./venice-1.12.63.jar
```
...
```text
foo> java -jar venice-1.12.63.jar -setup -colors
```
...
- Start a [REPL](https://github.com/jlangch/venice/blob/master/doc/readme/repl.md)
- browse through the [readme](https://github.com/jlangch/venice/blob/master/README.md#documentation)
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/8d86f4d/cheatsheet.pdf) and use it as a quick reference
