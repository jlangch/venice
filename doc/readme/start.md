...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.9/jar)

or download it with `curl`:

```
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.13.9/venice-1.13.9.jar
```
...
``` text
java -jar venice-1.13.9.jar -setup -colors -dir ./repl
```
...
``` text
java -jar venice-1.13.9.jar -setup -minimal -colors -dir ./repl
```
