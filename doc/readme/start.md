...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.5/jar)

or download it with `curl`:

```
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.13.5/venice-1.13.5.jar
```
...
``` text
java -jar venice-1.13.5.jar -setup -colors -dir ./repl
```
...
``` text
java -jar venice-1.13.5.jar -setup -minimal -colors -dir ./repl
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/dbbf7a7/cheatsheet.pdf) and use it as a quick reference
