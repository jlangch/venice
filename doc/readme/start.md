...
```text
foo> java -jar venice-1.9.15.jar -colors
```
...
```text
foo> java -cp venice-1.9.15.jar;jansi-1.18.jar com.github.jlangch.venice.Launcher -colors-darkmode
```
...
```text
foo> java -jar venice-1.9.15.jar -setup -colors
```
