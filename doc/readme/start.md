...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.12.89/jar)

or download it with `curl`:

```
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.12.89/venice-1.12.89.jar
```
...
``` text
java -jar venice-1.12.89.jar -setup -colors -dir ./repl
```
...
- see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/04265f3/cheatsheet.pdf) and use it as a quick reference
