...
Manually download the JAR from Maven: [Venice JAR](https://search.maven.org/artifact/com.github.jlangch/venice/1.13.12/jar)

or download it with `curl`:

```
curl -O https://repo1.maven.org/maven2/com/github/jlangch/venice/1.13.12/venice-1.13.12.jar
```
...
``` text
java -jar venice-1.13.12.jar -setup -minimal -colors -dir ./repl
```
