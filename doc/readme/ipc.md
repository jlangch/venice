...
Note: For API details please see the [cheatsheet](https://cdn.rawgit.com/jlangch/venice/6a469f2/cheatsheet.pdf) under *Overview* -> *I/O* -> *Inter Process Communication*
