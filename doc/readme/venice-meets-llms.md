...
The database scheme used in this SQL example from the Chinook database. 
...
```clojure
;; Dealing with SQL related prompty
(do
  (load-module :openai)
  ...
  (let [prompt      [ { :role     "system"
                      ...
                      { :role     "assistant"
                        :content  """
                                  Answer user questions by generating SQL queries against a database 
                                  whose schema will be given to you.
                                  """ }
                      { :role     "assistant"
                        :content  """
