...
Variant a) load the OpenAI api key from the env var OPENAI_API_KEY to create the client:
...
Variant b) passing an explicit OpenAI api key to create the client:
